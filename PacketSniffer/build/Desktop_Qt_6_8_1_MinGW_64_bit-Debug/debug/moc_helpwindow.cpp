...
static constexpr auto qt_meta_stringdata_ZN10HelpWindowE = QtMocHelpers::stringData(
    "HelpWindow"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN10HelpWindowE[] = {
...
Q_CONSTINIT const QMetaObject HelpWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10HelpWindowE.offsetsAndSizes,
    qt_meta_data_ZN10HelpWindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10HelpWindowE_t,
        // Q_OBJECT / Q_GADGET
...
void *HelpWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10HelpWindowE.stringdata0))
